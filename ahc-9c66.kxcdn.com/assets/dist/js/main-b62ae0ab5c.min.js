...
/*!********************************************************************************************!*\
  ...
  \********************************************************************************************/
/*! no static exports found */function(e,n){e.exports=t}})})),$(document).foundation(),$(".mobile-dropdown-button").click((function(){$(".mobile-dropdown-menu").slideToggle()})),$(".mobile-dropdown-button").click((function(){$("#hamburger").toggleClass("open")})),$(".inner-mobile-menu").click((function(){$(this).contents("ul").slideToggle(),$(this).toggleClass("mm-inactive mm-active"),$(this).find("i.fas").toggleClass("fa-plus fa-minus")})),$(document).ready((function(){$(document).on("forminvalid.zf.abide",(function(t,e){t.preventDefault();var n=$(".is-invalid-input");$("html, body").animate({scrollTop:$(n[0]).offset().top},200)}));var t=$("fieldset.checkbox-group.required");if(t.length>0){var e=$(t).find('input[type="checkbox"]');e.change((function(){if(e.is(":checked")){e.removeAttr("required");var t=$(e).closest("label");$(t).removeClass("is-invalid-label"),e.removeClass("is-invalid-input"),e.removeAttr(["data-invalid","aria-invalid"])}else e.attr("required","required")}))}}));